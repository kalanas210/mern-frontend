...
const MainBanner = () => {
    return (
        <div className='relative '>
            <img className="w-full h hidden md:block" src={assets.main_banner_bg} alt="main banner bg" />
            <img className="w-full md:hidden rounded-xl" src={assets.main_banner_bg_sm} alt="main banner bg sm" />
            ...
            md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
                ...
                >Fashion You Can Count On, Savings You Can't Resist!</h1>
